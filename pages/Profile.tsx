                ...
                <div className="w-full md:w-64 flex-shrink-0">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <div className="p-6 text-center border-b border-gray-100 bg-gray-50">
                            ...
                            <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-center gap-2 group cursor-pointer" onClick={() => { navigator.clipboard.writeText(user.id); setSuccessMsg('ID Copied!'); setTimeout(() => setSuccessMsg(''), 2000); }}>
                                <code className="text-[10px] bg-gray-100 px-2 py-1 rounded text-gray-500 font-mono group-hover:bg-gray-200 transition-colors">ID: {user.id}</code>
